...
O sistema está operando com **10.836 apreensões reais** importadas da planilha oficial:

### 📊 Estatísticas Gerais
- **10.836** apreensões totais (2010-2025)
  - **2.635** apreensões de 2025 (dados mais recentes)
  - **8.201** apreensões históricas (2010-2024)
...
- Arquivo original: 13.910 linhas (3.074 com datas inválidas foram filtradas)
...
- Importação completa com extração de:
  - Data da apreensão (validação 2010-2025)
...
- 3.074 registros com datas inválidas foram filtrados
